...
rev::CANSparkMax motor_R_main{4, rev::CANSparkMax::MotorType::kBrushless};
...
rev::CANSparkMax motor_L_main{1, rev::CANSparkMax::MotorType::kBrushless};
rev::CANSparkMax motor_L_follow{2, rev::CANSparkMax::MotorType::kBrushless};
